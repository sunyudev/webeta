...
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        ...
        <td><input hidden="hidden" id="roleId" value="${role.id }">
        <input id="roleName" type="text" name="roleName" value="${role.roleName }" onblur="repetition()"/>
    ...
    <tr>
        <td class="tableleft">权限<font color="red">(最少选择一种权限)</font></td>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <button  class="btn btn-primary" type="button" onclick="addUser()">更新</button> &nbsp;&nbsp;<button type="button" class="btn btn-success" name="backid" id="backid">返回列表</button>
        </td>
    </tr>
</table>
</form>
